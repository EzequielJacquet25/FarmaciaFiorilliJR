...
import logoVertical from "../assets/logoFarmaciaFiorilliJR.png";
const Footer = () => {
  useEffect(() => {
  ...
  return (
    <footer className="footer d-flex flex-column justify-content-between">
      ...
      <div className="d-flex flex-sm-row flex-column align-items-center justify-content-evenly">
        <div className="columna d-flex w-100 flex-column align-items-center justify-content-evenly justify-content-sm-center">
          <div className="mb-2">
            <img
              src={logoVertical}
              alt="Logo "
              className="logoVertical  aparece-desde-izquierda"
            />
          </div>
          <div>
            ...
            <h4>-Razón Social </h4>
            <small>FIORILLI MONICA BEATRIZ / CUIT : 23182980714 </small>
          </div>
        </div>

        <nav className="columna w-100 d-flex flex-column align-items-center justify-content-evenly aparece-desde-izquierda">
          <a
            className="linksFooter d-flex align-items-center gap-2"
            href="/sobreNosotros"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="columna w-100 d-flex flex-column align-items-center justify-content-evenly justify-content-sm-center aparece-desde-izquierda">
          <p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
            ...
            <a
              href="tel:+541154307405"
              target="_blank"
              className="text-light m-0 px-2 linksFooter"
            >
              (+54) 5430-7405
            </a>
          </p>
